...
% 12h do Dia 4 de Janeiro s�o 3 transi��es (passaram 3 dias)
prob = H^3 * X;
fprintf('\n-------------------------\n');
fprintf('No dia 4 de Janeiro, �s 12h:')
fprintf('\nAna: %.2f�', prob(1) * total);
...
% Logo depois da passagem de ano para o ano de 2016 s�o 364 transi��es
% (passaram 364 dias)
prob = H^364 * X;
...
fprintf('\n-------------------------\n');
i
fprintf('i = 9 pelo que ser� no dia 10 de Janeiro de 2016\n');
